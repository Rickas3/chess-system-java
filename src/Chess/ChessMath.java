...
public class ChessMath {
    ...
    private Piece makeMove(Position source, Position target){
        ...
        //MOVIMENTO ESPECIAL CASTLING VERIFICAR SE torre do lado do rei "PEQUENO"
        ...
        //MOVIMENTO ESPECIAL CASTLING VERIFICAR torre do lado do rei "GRANDE"
        if(p instanceof  King && target.getColumn() == source.getColumn() - 2){
        ...
        //MOVIMENTO ESPECIAL VERIFICAR EN PASSANT
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece){
        ...
        //DESFAZER MOVIMENTO ESPECIAL CASTLING VERIFICAR SE torre do lado do rei "PEQUENO"
        if(p instanceof  King && target.getColumn() == source.getColumn() + 2){
            Position sourceT = new Position(source.getRow(), source.getColumn() + 3);
            Position targetT = new Position(source.getRow(), source.getColumn() + 1);
        ...
        //DESFAZER MOVIMENTO ESPECIAL CASTLING VERIFICAR torre do lado do rei "GRANDE"
        if(p instanceof  King && target.getColumn() == source.getColumn() - 2){
            Position sourceT = new Position(source.getRow(), source.getColumn() - 4);
            Position targetT = new Position(source.getRow(), source.getColumn() - 1);
            ChessPiece rook = (ChessPiece) board.removePiece(targetT);
    ...
    private boolean testCheck(Color color){
        ...
        List<Piece> opponentPieces = piecesOnTheBoard.stream().filter(x ->((ChessPiece)x).getColor() == oppnent(color)).collect(Collectors.toList());
